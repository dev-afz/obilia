...
mixAssetsDir('site/js/**/*.js', (src, dest) => mix.scripts(src, dest))
mixAssetsDir('site/css/**/*.css', (src, dest) => mix.copy(src, dest))
mixAssetsDir('site/img', (src, dest) => mix.copy(src, dest))
mixAssetsDir('site/fonts', (src, dest) => mix.copy(src, dest))
