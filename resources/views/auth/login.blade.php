                ...
                <div class="card-body">
                    <a href="#" class="brand-logo">
                        ...
                        <h2 class="brand-text text-primary ms-1">
                            {{ Str::ucfirst(str_replace('_', ' ', config('app.name'))) }}
                        </h2>
                    </a>

                    <h4 class="card-title mb-1">Welcome to {{ Str::ucfirst(str_replace('_', ' ', config('app.name'))) }}! 👋
                    </h4>
                    ...
                    <form class="auth-login-form mt-2" method="POST" action="{{ route('admin.auth.login') }}">
                        @csrf
                        <div class="mb-1">
