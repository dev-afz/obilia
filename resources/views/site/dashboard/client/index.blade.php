    ...
    <x-site.dashboard.body>
        <div class="row">
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="dashboard-stat">
                    <div class="dashboard-stat-icon widget-1">
                        <svg aria-hidden="true" focusable="false" data-prefix="fa-duotone" data-icon="briefcase-blank"
                    ...
                    <div class="dashboard-stat-content">
                        <h4><span class="cto">{{ $totalJobs }}</span></h4>
                        <p>Job Posted</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="dashboard-stat">
                    <div class="dashboard-stat-icon widget-1">
                        <svg aria-hidden="true" focusable="false" data-prefix="fa-duotone" data-icon="briefcase"
                    ...
                    <div class="dashboard-stat-content">
                        <h4><span class="cto">{{ $activeJobs }}</span></h4>
                        <p>Active Jobs</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="dashboard-stat">
                    <div class="dashboard-stat-icon widget-1">
                        <svg aria-hidden="true" focusable="false" data-prefix="fa-duotone" data-icon="calendar-check"
                    ...
                    <div class="dashboard-stat-content">
                        <h4><span class="cto">{{ $completedJobs }}</span></h4>
                        <p>Completed Jobs</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                <div class="dashboard-stat">
                    <div class="dashboard-stat-icon widget-1">
                        <svg aria-hidden="true" focusable="false" data-prefix="fa-duotone" data-icon="circle-xmark"
                            class="svg-inline--fa fa-circle-xmark fa-w-16" role="img"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <defs>
                                <style>
                                    .fa-secondary {
                    ...
                    <div class="dashboard-stat-content">
                        <h4><span class="cto">{{ $cancelledJobs }}</span></h4>
                        <p>Cancelled Jobs</p>
                    </div>
                </div>
            </div>
