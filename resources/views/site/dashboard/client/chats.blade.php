                                        ...
                                        <ul class="list-unstyled user-status">
                                            <li class="pb-1">
                                                <div class="form-check form-check-success">
                                                    ...
                                                    <label class="form-check-label ms-25"
                                                        for="activeStatusRadio">Active</label>
                                                </div>
                                            </li>
                                            <li class="pb-1">
                                            ...
                                            <li class="pb-1">
                                                <div class="form-check form-check-warning">
                                                    ...
                                                    <label class="form-check-label ms-25"
                                                        for="awayStatusRadio">Away</label>
                                                </div>
                                            </li>
                                            <li class="pb-1">
                                            ...
                                            <li>
                                                ...
                                                <div class="chat-info flex-grow-1">
                                                    ...
                                                    <p class="card-text text-truncate">
                                                        Cake pie jelly jelly beans. Marzipan lemon drops halvah cake.
                                                        Pudding
                                        ...
                                        <ul class="chat-users-list contact-list media-list">
                                            ...
                                            <li>
                                                ...
                                                <div class="chat-info">
                                                    ...
                                                    <p class="card-text text-truncate">
                                                        Tootsie roll sesame snaps biscuit icing jelly-o biscuit chupa
                                                        chups
                                                        powder.
                                                    </p>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="chat-info">
                                                    <h5 class="mb-0">Kristopher Candy</h5>
                                                    <p class="card-text text-truncate">
                                                        Marzipan bonbon chocolate bar biscuit lemon drops muffin jelly-o
                                                        sweet
                                                        jujubes.
                                                    </p>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="chat-info">
                                                    ...
                                                    <p class="card-text text-truncate">
                                                        Toffee gummi bears sugar plum gummi bears chocolate bar donut.
                                                        Pudding
                                                        cookie lemon drops icing
                                                    </p>
                                                </div>
                                ...
                                <div class="content-body">
                                                ...
                                                <div class="chats">
                                                    ...
                                                    <div class="chat">
                                                        ...
                                                        <div class="chat-body">
                                                            ...
                                                            <div class="chat-content">
                                                                <p>Vuexy admin is the responsive bootstrap 4 admin
                                                                    template.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <form class="chat-app-form" action="javascript:void(0);"
                                                ...
                                                <div class="input-group input-group-merge me-1 form-send-message">
                                                    <span class="speech-to-text input-group-text"><i
                                                            data-feather="mic" class="cursor-pointer"></i></span>
                                    ...
                                    <div class="user-profile-sidebar">
                                        ...
                                        <div class="user-profile-sidebar-area">
                                            <!-- About User -->
                                            <h6 class="section-label mb-1">About</h6>
                                            <p>Toffee caramels jelly-o tart gummi bears cake I love ice cream lollipop.
                                            </p>
                                            <!-- About User -->
